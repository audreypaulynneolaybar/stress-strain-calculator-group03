...
from properties import MaterialData

# Predefined material database populated with dataclass instances
PREDEFINED_MATERIALS: Dict[str, MaterialData] = {
    "1": MaterialData(
...
def get_all_materials() -> Dict[str, MaterialData]:
    """Returns the dictionary of all predefined materials."""
    return PREDEFINED_MATERIALS


def get_material_by_key(key: str) -> Optional[MaterialData]:
    """
...
def add_custom_material(key: str, material: MaterialData) -> None:
